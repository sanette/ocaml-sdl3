...
let int64_as_ullong =
  view ~read:Unsigned.ULLong.to_int64 ~write:Unsigned.ULLong.of_int64 ullong
let int64_as_llong =
  view ~read:Signed.LLong.to_int64 ~write:Signed.LLong.of_int64 llong
let int_as_ushort =
...
module AsyncIOOutcome = struct
  ...
  let offset = field t "offset" int64_as_ulong
  let bytes_requested = field t "bytes_requested" int64_as_ulong
...
module PixelFormatDetails = struct
  ...
  let bits_per_pixel = field t "bits_per_pixel" int_as_uchar
  let bytes_per_pixel = field t "bytes_per_pixel" int_as_uchar
  ...
  let rbits = field t "Rbits" int_as_uchar
  let gbits = field t "Gbits" int_as_uchar
  let bbits = field t "Bbits" int_as_uchar
  let abits = field t "Abits" int_as_uchar
  let rshift = field t "Rshift" int_as_uchar
  let gshift = field t "Gshift" int_as_uchar
...
module Surface = struct
  ...
  let flags = field t "flags" int_as_uint
  let format = field t "format" pixel_format
  let w = field t "w" int
  let h = field t "h" int
...
module DisplayMode = struct
  ...
  let display_id = field t "displayID" int_as_uint
  let format = field t "format" pixel_format
  let w = field t "w" int
  let h = field t "h" int
...
module VirtualJoystickDesc = struct
  ...
  let version = field t "version" int_as_uint
  let typ = field t "type" int_as_ushort
  let padding = field t "padding" int_as_ushort
  let vendor_id = field t "vendor_id" int_as_ushort
  let product_id = field t "product_id" int_as_ushort
  let naxes = field t "naxes" int_as_ushort
  let nbuttons = field t "nbuttons" int_as_ushort
  let nballs = field t "nballs" int_as_ushort
  let nhats = field t "nhats" int_as_ushort
  let ntouchpads = field t "ntouchpads" int_as_ushort
  let nsensors = field t "nsensors" int_as_ushort
...
module Finger = struct
  ...
  let id = field t "id" int64_as_ulong
  let x = field t "x" float
  let y = field t "y" float
...
module KeyboardEvent = struct
  ...
  let key = field t "key" int_as_uint
  let mod_ = field t "mod" int_as_ushort
  let raw = field t "raw" int_as_ushort
...
module MouseMotionEvent = struct
  ...
  let window_id = field t "windowID" int_as_uint
  let which = field t "which" int_as_uint
  let state = field t "state" int_as_uint
  let x = field t "x" float
  let y = field t "y" float
...
module MouseButtonEvent = struct
  ...
  let down = field t "down" bool
  let clicks = field t "clicks" int_as_uchar
  let padding = field t "padding" int_as_uchar
  let x = field t "x" float
  let y = field t "y" float
  let () = seal t
end
...
module JoyAxisEvent = struct
  ...
  let timestamp = field t "timestamp" int64_as_ulong
  let which = field t "which" int_as_uint
  let axis = field t "axis" int_as_uchar
  let padding1 = field t "padding1" int_as_uchar
  let padding2 = field t "padding2" int_as_uchar
  let padding3 = field t "padding3" int_as_uchar
...
module JoyBallEvent = struct
  ...
  let timestamp = field t "timestamp" int64_as_ulong
  let which = field t "which" int_as_uint
  let ball = field t "ball" int_as_uchar
  let padding1 = field t "padding1" int_as_uchar
  let padding2 = field t "padding2" int_as_uchar
  let padding3 = field t "padding3" int_as_uchar
...
module JoyHatEvent = struct
  ...
  let timestamp = field t "timestamp" int64_as_ulong
  let which = field t "which" int_as_uint
  let hat = field t "hat" int_as_uchar
  let value = field t "value" int_as_uchar
  let padding1 = field t "padding1" int_as_uchar
  let padding2 = field t "padding2" int_as_uchar
  let () = seal t
end
...
module TouchFingerEvent = struct
  ...
  let reserved = field t "reserved" uint32
  let timestamp = field t "timestamp" int64_as_ulong
  let touch_id = field t "touchID" int64_as_ulong
  let finger_id = field t "fingerID" int64_as_ulong
  let x = field t "x" float
  let y = field t "y" float
...
module PenMotionEvent = struct
  ...
  let window_id = field t "windowID" int_as_uint
  let which = field t "which" int_as_uint
  let pen_state = field t "pen_state" int_as_uint
  let x = field t "x" float
  let y = field t "y" float
  let () = seal t
end
...
module PathInfo = struct
  ...
  let size = field t "size" int64_as_ulong
...
module GPUColorTargetBlendState = struct
  ...
  let color_write_mask = field t "color_write_mask" int_as_uchar
...
module GPUTextureCreateInfo = struct
  ...
  let usage = field t "usage" int_as_uint
...
module GPUDepthStencilState = struct
  ...
  let compare_mask = field t "compare_mask" int_as_uchar
  let write_mask = field t "write_mask" int_as_uchar
...
module GPUDepthStencilTargetInfo = struct
  ...
  let cycle = field t "cycle" bool
  let clear_stencil = field t "clear_stencil" int_as_uchar
...
module HapticConstant = struct
  ...
  let delay = field t "delay" int_as_ushort
  let button = field t "button" int_as_ushort
  let interval = field t "interval" int_as_ushort
  let level = field t "level" sint16
  let attack_length = field t "attack_length" int_as_ushort
  let attack_level = field t "attack_level" int_as_ushort
...
module HapticPeriodic = struct
  ...
  let button = field t "button" int_as_ushort
  let interval = field t "interval" int_as_ushort
  let period = field t "period" int_as_ushort
  let magnitude = field t "magnitude" sint16
  let offset = field t "offset" sint16
  let phase = field t "phase" int_as_ushort
  let attack_length = field t "attack_length" int_as_ushort
  let attack_level = field t "attack_level" int_as_ushort
  let fade_length = field t "fade_length" int_as_ushort
  let fade_level = field t "fade_level" int_as_ushort
...
module HapticCustom = struct
  ...
  let button = field t "button" int_as_ushort
  let interval = field t "interval" int_as_ushort
  let channels = field t "channels" int_as_uchar
  let period = field t "period" int_as_ushort
  let samples = field t "samples" int_as_ushort
...
module Hid_device_info = struct
  ...
  let release_number = field t "release_number" int_as_ushort
  let manufacturer_string = field t "manufacturer_string" (ptr int32_t)
  let product_string = field t "product_string" (ptr int32_t)
  let usage_page = field t "usage_page" int_as_ushort
  let usage = field t "usage" int_as_ushort
